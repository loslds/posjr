...
import loginprt from '~/assets/images/loginprt.png';
import logosys from '~/assets/images/logosys.png';
import ButtonPgLogin from '~/components/buttons/ButtonPgLogin';
import Header from '~/components/Header';
import { LayoutPg } from '~/components/layouts';
import { MenuPgLeft, MenuPgHidth } from '~/components/menus';
import { MenuContainerPgLogo } from '~/components/menus/styles';
import { DivisionPanel } from '~/pages/styledPage';
...
export const HomePage = () => {
  ...
  return (
    <LayoutPg>
      <Header>
        <MenuPgLeft>
          <MenuContainerPgLogo img={logosys} />
          <h2>JR- Bordados.</h2>
        </MenuPgLeft>
        <MenuPgHidth>
          <label>Logar...: </label>
          <ButtonPgLogin img={loginprt} title={'Click aqui para Logar...'} />
        </MenuPgHidth>
      </Header>
      <DivisionPanel />
